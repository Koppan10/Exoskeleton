#This python script provides a communication between Shimmer sensor. 
#We can stream  raw sensor data of one channel directly and view the muscle contraction including artifact.
